Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "08afd308918dc7ab4054410ff2e48fc0ce38234a9e0ddcce"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.datastore_root_path = "/Users/dawn/rails_projects/blipub/public/system/refinery/resources"
